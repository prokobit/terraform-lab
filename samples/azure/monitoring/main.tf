...
#   name                    = "${var.prefix}-mdcra"
#   target_resource_id      = var.kubernetes_cluster_id
#   data_collection_rule_id = azurerm_monitor_data_collection_rule.id
# }
...
#   principal_id         = azurerm_dashboard_grafana.tfpk.identity[0].principal_id <-- any service account
# }
